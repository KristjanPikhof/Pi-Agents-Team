...
test("local ThinkingLevel matches the supported Pi contract", () => {
	assert.deepEqual(THINKING_LEVELS, PI_THINKING_LEVELS);
});

test("upstream ThinkingLevel stays locked to the tested Pi contract", () => {
